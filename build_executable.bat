...
if exist "DnD_CharacterSheet_Generator.spec" del "DnD_CharacterSheet_Generator.spec"
...
echo.
if exist "dist\DnD_CharacterSheet_Generator.exe" (
    echo =========================================
    echo BUILD SUCCESSFUL!
    echo =========================================
    echo.
    echo Executable created at:
    echo   dist\DnD_CharacterSheet_Generator.exe
    echo.
    echo File size:
    for %%A in ("dist\DnD_CharacterSheet_Generator.exe") do echo   %%~zA bytes
    echo.
) else (
    echo =========================================
    echo BUILD FAILED!
